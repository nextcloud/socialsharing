OC.L10N.register(
    ...
    "Enable direct sharing of files via Bluesky, using shared links. \n\t\nThis app always links to bsky.app. Using other domains is not possible with this app." : "Umumiy havolalar yordamida Moviy osmon orqali fayllarni to'g'ridan-to'g'ri almashishni yoqing.\n\t\nBu ilova har doim bsky.app ga havola qiladi. Bu ilova bilan boshqa domenlardan foydalanish mumkin emas.",
